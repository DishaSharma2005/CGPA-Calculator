...
document.querySelector('#btn_re').addEventListener('click',() =>{
  ...
  document.querySelector('#first semester cgpa').value='';
  document.querySelector('#second  semester cgpa ').value='';
  document.querySelector('#third semester cgpa').value='';
  document.querySelector('#fourth semester cgpa').value='';
  document.querySelector('#fifth semester cgpa').value='';
  document.querySelector('#sixth semester cgpa').value='';
  document.querySelector('#seventh semester cgpa').value='';
  document.querySelector('#eighth semeseter cgpa').value='';
})
